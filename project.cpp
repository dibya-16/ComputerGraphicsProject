...
//click "d" for day view,"n" for night view,"f" for flood view,"o" for object moving after flood;
...
void updateCloudleft(int value) {
 _moveCloudleft -= .02 ;
...
//    glMatrixMode(GL_MODELVIEW);
     glPushMatrix();
    glTranslatef( 0.0f,_moveWater,0.00f);
    glBegin(GL_QUADS);
    glColor3ub(66, 165, 196);
    glVertex2f(-0.64f,-0.61f);
    glVertex2f(0.64f,-0.61f);
...
case 'n':
            glutDestroyWindow(1);
//glutInit(&argc, argv);
glutInitWindowSize(1930, 1080); // Initialize GLUT
